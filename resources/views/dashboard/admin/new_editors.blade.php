...
@endsection
@section('content')
<?php use Illuminate\Support\Facades\DB; use Illuminate\Support\Facades\Auth;  $editors = DB::table('editors')->select('*')->where('etat','attend')->orWhere('etat','traitement')->get();?>
                                                    ...
                                                    <div class="row m-l-0 m-r-0">
                                                        <div class="col-sm-4 bg-c-lite-green user-profile">
                                                            <div class="card-block text-center text-white">
                                                                ...
                                                                <h6 class="f-w-600">{{$editor->first_name}} {{$editor->last_name}}</h6>
                                                                <p>éditeur</p>
                                                            ...
                                                            <div class="card-block">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6" style="display: flex;justify-content:space-between">
                                                                        ...
                                                                        <a href=""><a href="" style="color: black; margin-right:50px"><i class="fa-solid fa-download fa-xl"></i></a>
                                                                    </div>
                                                                    <div class="col-sm-6" style="display: flex;justify-content:space-between">
