    ...
    <div class="main-content">
      ...
      <div class="header pb-8 pt-5 pt-lg-8 d-flex align-items-center" style="min-height: 400px; width:100%; margin-top:-20px ;background-image: url(https://raw.githubusercontent.com/creativetimofficiahttps://images.unsplash.com/photo-1529665253569-6d01c0eaf7b6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8cHJvZmlsZXxlbnwwfHwwfHw%3D&w=1000&q=80l/argon-dashboard/gh-pages/assets-old/img/theme/profile-cover.jpg); background-size: cover; background-position: center top;">
        ...
        <div class="container-fluid d-flex align-items-center">
          <div class="row">
            <div class=" col-md-10">
              <h1 class="display-2 text-white">Bienvenue {{$edit->first_name}}</h1>
            ...
            <div class="card card-profile shadow">
              <div class="row justify-content-center">
                <div class="col-lg-3 order-lg-2">
                  <div class="card-profile-image">
                    <a href="#">
                      <img src="{{asset('/storage/images/editors/'.$edit->pic)}}" style="height: 150px;width:150px" class="rounded-circle">
                    </a>
                  </div>
                </div>
              </div>
              ...
              <div class="card-body pt-0 pt-md-4">
                ...
                <div class="text-center" style="padding: 20px;">
                  ...
                  <h3 style="margin-top :-10px">{{$edit->age}} ans</h3>
                  <div class="h5 mt-4">
                    <i class="ni business_briefcase-24 mr-2"></i>editor
                  </div>
                  <hr class="my-4">
                  <a href="{{route('editor.edit-profile')}}" class="btn btn-info">modifier le profil</a>
                  <a href="{{route('editor.password')}}" class="btn btn-info" style="margin-top:5px">changer le mot de passe</a>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="card-body">
                <form>
                  ...
                  <div class="pl-lg-4">
                    <div class="form-group focused">
                      <label>Sur moi</label>
                      <textarea rows="4" class="form-control form-control-alternative" placeholder="Quelques mots sur vous..." name="biographie">{{$edit->biographie}}</textarea>
                    </div>
                  </div>
                </form>
              </div>
