...
@section('content')
@foreach($reviewer as $auth)
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700" rel="stylesheet">
    <div class="main-content" style="background:#111824;">
      <!-- Header -->
            ...
            <div class="card card-profile shadow">
              <div class="row justify-content-center">
                <div class="col-lg-3 order-lg-2">
                  <div class="card-profile-image">
                    <a href="#">
                      <img src="{{asset('/storage/images/reviewers/'.$auth->pic)}}" style="height: 150px;width:150px" class="rounded-circle">
                    </a>
                  </div>
                </div>
              </div>
              ...
              <div class="card-body pt-0 pt-md-4">
                ...
                <div class="text-center" style="padding: 20px;">
                  ...
                  <hr class="my-4">
                  <a href="{{route('reviewer.edit-profile')}}" class="btn btn-info">modifier le profil</a>
                  <a href="{{route('reviewer.password')}}" class="btn btn-info" style="margin-top:5px">changer le mot de passe</a>
                </div>
              </div>
            </div>
          </div>
