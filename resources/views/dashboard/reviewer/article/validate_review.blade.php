				...
				@foreach ($articles as $article)
					<tr class="bg-gray-800" >
						...
						<div style="display:flex; justify-content:center;">
							...
							<input type="submit" value="Réviser l'article" style="text-decoration: none;margin-right:10px; color:maroon" class="bg-green-400 text-gray-50 rounded-md px-2"></input>
						</form>
						</div>	
						</td>
					</tr>
