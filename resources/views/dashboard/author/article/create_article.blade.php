...
<div class="wrapper">
	...
	@csrf
        <div id="wizard">
            ...
            <h4></h4>
            <section>
                <div class="form-row"> <input type="text" class="form-control" name="title" placeholder="Titre"></div>
                <div class="form-row"> 
                ...
                <div class="form-row"> <input type="number" min="0" max="10" class="form-control" name="nbrfigure" placeholder="Nombre de figures"> </div>
            </section> <!-- SECTION 2 -->
            <h4></h4>
            <section>
