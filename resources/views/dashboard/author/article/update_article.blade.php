...
<div class="wrapper">
    <form method="POST" action="{{ route('author.do_update') }}"  enctype="multipart/form-data">
	@csrf
        <div id="wizard">
            <!-- SECTION 1 -->
            <h4></h4>
            <section>
                <div class="form-row"> <input type="text" class="form-control" name="title" value="{{$article->title}}"> </div>
                <div class="form-row"> 
                ...
                <div class="form-row"> <input type="number" min="0" max="10" class="form-control" name="nbrfigure" value="{{$article->nbrfigure}}"> </div>
            </section> <!-- SECTION 2 -->
            <h4></h4>
            <section>
                <div class="form-row"> <textarea name="abstract" class="form-control" cols="30" rows="10" placeholder="abstract">{{$article->abstract}}</textarea> </div>
            </section> <!-- SECTION 3 -->
            <h4></h4>
            <section>
						<!-- component -->
