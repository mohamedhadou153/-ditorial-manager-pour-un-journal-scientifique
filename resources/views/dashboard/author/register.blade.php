...
<style>
    ...
    *{
    ...
    body{
      background-image: linear-gradient(to right top, #eeba77, #be8f59, #8f673c, #634221, #392004);  min-height: 100vh;
      display: flex;
      align-items: center;
    ...
    .forms .form-content .button input:hover{
      background-image: linear-gradient(to right top, #c238b0, #a134a6, #812f9a, #612a8c, #42247c);
    }
